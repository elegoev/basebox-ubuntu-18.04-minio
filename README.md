...
The base image is provisioned with bash script [ubuntu-18.04-minio.sh](https://github.com/elegoev/vagrant-ubuntu1804-minio/blob/master/provisioning/ubuntu-18.04-minio.sh)
